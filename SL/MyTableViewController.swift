...
class MyTableViewController: UITableViewController, NFCNDEFReaderSessionDelegate, CLLocationManagerDelegate{//
    ...
    @IBAction func scan(_ sender: Any) {
        ...
        session.alertMessage = "Scan NFC tag to open the door"
        session.begin()
